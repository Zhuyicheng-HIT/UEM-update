...
We provide the dataset in the following two formats. Download as necessary. (Update: )
...
Update: If the links above are slow, a mirror is available on HuggingFace [here](https://huggingface.co/datasets/chaitanya100100/uniegomotion/tree/main).
